<%-- 
    Document   : mostrarViajeConPasajeros
    Created on : 13-mar-2019, 12:38:42
    Author     : diego
--%>
...
<html>
    ...
    <body style="background-image:url(IMAGENES/carretera.jpg);background-size:100% 100%;background-attachment:fixed;background-repeat:no-repeat;">
        ...
        <%
            try {
                List<Viaje> viajePorFechaConOcupacion = (List<Viaje>) request.getAttribute("viajePorFechaConOcupacion");

                Iterator iter = viajePorFechaConOcupacion.iterator();
            ...
            <div style="width: 80%; margin: 0 auto; text-align: center; background: white; margin-bottom: 10px; margin-top: 20px; opacity: 0.9">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        %>
                        <tr>
                            <td><%= ocupacion.getViajero().getNumeroIdentificacion() %></td>
                            <td><%= ocupacion.getViajero().getNombre() %> </td>
                            <td><%= ocupacion.getViajero().getApellidos() %></td>
                            <td><%= ocupacion.getNumeroAsiento() %></td>
